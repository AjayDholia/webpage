...
function Secondsection() {
  return (
    <div className='secondsection'>
      ...
      <p className='pa'>C.R.I. FLUID SYSTEMS PRODUCTS CATER TO DIVERSE SEGMENTS</p>
      <p className='par'>CHEMICALS & PROCESS |POWER | WATER & WASTE WATER | OILS & GAS 
        | PHARMA | SUGARS & DISTILLERIES | PAPER & PULP | MARINE & DEFENCE| METAL & MINING | FOOD & BEVERAGE | PETROCHEMICAL & REFINERIES | SOLAR | BUILDING |
